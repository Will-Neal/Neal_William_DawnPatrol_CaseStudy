...
/**
 * @author willw
 * POJO that describes Surfboards in the application and determines the structure of Surfboards saved to database.
 * Id is an Integer which is autogenerated. Has a Many to One relationship with Users on foreign key user_id.
 * If the associated User is deleted the Surfboard will be deleted. 
 */
@Component
@Entity
